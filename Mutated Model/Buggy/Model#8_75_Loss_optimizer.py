...
current = '{0}/{1}/'.format(currentPATH,'Metrics_75')
...
model.compile(optimizer =keras.optimizers.Adagrad(learning_rate = 0.001), loss='kullback_leibler_divergence', metrics=['accuracy'])
