...
current = '{0}/{1}/'.format(currentPATH,'Metrics_6')
...
model.compile(optimizer=keras.optimizers.Adam(learning_rate = 0.5), loss='kullback_leibler_divergence', metrics=['accuracy'])
