...
current = '{0}/{1}/'.format(currentPATH,'Metrics_74')
...
model.compile(optimizer =keras.optimizers.RMSprop(learning_rate = 0.001), loss='kullback_leibler_divergence', metrics=['accuracy'])
