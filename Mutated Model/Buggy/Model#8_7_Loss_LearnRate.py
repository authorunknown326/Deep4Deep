...
current = '{0}/{1}/'.format(currentPATH,'Metrics_7')
...
model.compile(optimizer=keras.optimizers.Adam(learning_rate = 0.75), loss='kullback_leibler_divergence', metrics=['accuracy'])
