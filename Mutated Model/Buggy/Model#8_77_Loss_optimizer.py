...
current = '{0}/{1}/'.format(currentPATH,'Metrics_77')
...
model.compile(optimizer =keras.optimizers.Adamax(learning_rate = 0.001), loss='kullback_leibler_divergence', metrics=['accuracy'])
