...
current = '{0}/{1}/'.format(currentPATH,'Metrics_71')
...
model.compile(optimizer =keras.optimizers.Adadelta(learning_rate = 0.001), loss='mean_absolute_percentage_error', metrics=['accuracy'])
