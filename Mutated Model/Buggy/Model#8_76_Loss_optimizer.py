...
current = '{0}/{1}/'.format(currentPATH,'Metrics_76')
...
model.compile(optimizer =keras.optimizers.Adadelta(learning_rate = 0.001), loss='kullback_leibler_divergence', metrics=['accuracy'])
