...
current = '{0}/{1}/'.format(currentPATH,'Metrics_69')
...
model.compile(optimizer =keras.optimizers.RMSprop(learning_rate = 0.001), loss='mean_absolute_percentage_error', metrics=['accuracy'])
