...
current = '{0}/{1}/'.format(currentPATH,'Metrics_1')
...
model.fit(train_X, train_y, batch_size=512, epochs=120, callbacks=[tf.keras.callbacks.Metrics(train_X, train_y, len(model.layers), batch_size=512, lr=0.001, PATH=current)  ])
