...
current = '{0}/{1}/'.format(currentPATH,'Metrics_73')
...
model.compile(optimizer =keras.optimizers.SGD(learning_rate = 0.001), loss='kullback_leibler_divergence', metrics=['accuracy'])
